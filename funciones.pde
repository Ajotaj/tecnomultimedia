...
void pantalla2() {
  ...
  text( "estas en el basto océano", 140,60 );
  text( "Da click en la flecha ", 129,130 );
  text( "para avanzar a donde quieras", 160,170 ); 
}
//--------------------------------------------------------------------------pantalla3
//--------------------------------------------------------------------------pantalla
void pantalla3() {
 image(imagen[2],600,400,1200,800);
  ...
  fill( 0 );
  textFont( Fuente4, 24 );
  text( "Fido se encuentra con un pez que le dice como llegar a su destino;\ndice: que siga adelante pero va tener que crusar un torbellino de agua", 600,750 );  
}
//--------------------------------------------------------------------------pantalla4
//--------------------------------------------------------------------------pantalla
void pantalla4() {
